-- Fix schema cache for transfer_my_personal_wallet_to_merchant function
-- This script ensures the function is properly registered in the schema cache
...
-- Recreate the function with proper schema cache registration
