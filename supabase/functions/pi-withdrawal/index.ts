...
// Use npm specifier — Supabase Edge Runtime resolves npm packages via Node compat,
// which avoids the sodium-native binary addon issue you get with esm.sh builds.
// @ts-ignore
import StellarSdk from "npm:stellar-sdk@11.3.0";
